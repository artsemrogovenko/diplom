...
document.addEventListener('DOMContentLoaded', function () {
    const mainList = document.getElementById('mainList_module_list');
    const selectedList = document.getElementById('selectedList_modules');
    const selectedItems = {};
    ...
    form.addEventListener('submit', function () {
        ...
        hiddenField2.value = JSON.stringify(Object.keys(selectedItems));
    });
});
